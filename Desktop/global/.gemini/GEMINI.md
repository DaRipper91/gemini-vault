...
- User requires a unified synchronization strategy for .gemini configuration files, init scripts, custom agents, and skills across all environments, specifically linking the main Linux workstation with the Android (Pixel 9) Gemini CLI via Termux/ADB. This is a high-priority architectural goal.
